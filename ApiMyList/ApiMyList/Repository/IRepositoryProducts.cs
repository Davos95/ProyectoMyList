...
namespace ApiMyList.Repository
{
    public interface IRepositoryProducts
    {
        ...
        void InsertarProducto(int IdLista, String Nombre, int Cantidad, double Precio, bool chekced);
        void EliminarProducto(int id, int IdLista);
        void ModificarProducto(int id, int IdLista, String Nombre, int Cantidad, double Precio, bool chekced);
